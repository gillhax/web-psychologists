...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s записей на странице', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Отображено с %s по %s из %s записей', pageFrom, pageTo, totalRows);
        },
        formatSearch: function () {
            return 'Поиск';
        },
        formatNoMatches: function () {
            return 'Совподащих записей не найдено';
        },
